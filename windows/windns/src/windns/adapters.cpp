...
//
// TODO: This class is copied from the win-wireguard branch since that isn't merged yet
// This code should probably be moved to libcommon since it needs to be used in both
// windns and winnet.
//
